...
import static fr.cyrilneveu.craftorium.api.machine.behaviour.RecipeProcessor.*;
...
public class MachineRecipeBuilder
{
    ...
    public MachineRecipe build()
    {
        // if (name == null || name.isEmpty())
        {
            ...
            // System.out.println(Utils.generateRecipeName(itemsIn, fluidsIn, itemsOut, fluidsOut));
            this.name = Utils.generateRecipeName(itemsIn, fluidsIn, itemsOut, fluidsOut);
        }
