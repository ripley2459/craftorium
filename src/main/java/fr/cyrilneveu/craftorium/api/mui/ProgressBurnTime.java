...
public class ProgressBurnTime extends AWidget implements ITextured {
    public static final ResourceLocation ARROW = new ResourceLocation(MODID, "textures/interfaces/elements/furnace.png");
    public static final Size TEXTURE_SIZE = new Size(28, 14);
    public static final Size NORMAL_SIZE = new Size(14, 14);
    private int actual, max;

    public ProgressBurnTime(Position position) {
    ...
    public void drawBackground(int mouseX, int mouseY, float partialTicks) {
        ...
        if (max != 0) {
            int p = getSize().getSizeY() * actual / max;
